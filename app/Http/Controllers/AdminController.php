...
class AdminController extends Controller
{
    ...
    public function index()
    {
        ...
        $totalbusinesscount = User::where('approval', 1)->sum('amount');
        $getalluser = User::count();
        $getallappuser = User::where('approval', 1)->count();
        $totalbusinesscount1 = Jazzwith::where('app', 1)->sum('amount');
        $totalbusinesscount2= Easywith::where('app', 1)->sum('amount');
        $totalbusinesscount3 = Paywith::where('app', 1)->sum('amount');
        $totalbusinesscount4 = Skrillwith::where('app', 1)->sum('amount');
        $totalwithdarw = $totalbusinesscount1 + $totalbusinesscount2 + $totalbusinesscount3 + $totalbusinesscount4;
